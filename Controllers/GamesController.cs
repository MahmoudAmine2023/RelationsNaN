...
namespace RelationsNaN.Controllers
{
    public class GamesController : Controller
    {
        ...
        {
            var relationsNaNContext = _context.Game.Include(g => g.Genre).Include(x =>x.Platforms);
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            List<Platform> platformsList =  _context.Platforms.ToList();
            ViewData["Platforms"] = new SelectList(_context.Platforms, "Id", "Name", null);
        ...
        public async Task<IActionResult> AddPlatform(int platformId, int id)
        {
            ...
            var platform = await _context.Platforms.FirstOrDefaultAsync(m => m.Id == platformId);
        ...
        public async Task<IActionResult> RemovePlatform(int platformId ,int id)
        {
